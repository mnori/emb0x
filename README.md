...
- the database container listens on localhost:3306. username "admin" and password "confidentcats4eva". you can use whatever you want for this, my favourite DB client is "DBeaver", which works great just has a silly name
